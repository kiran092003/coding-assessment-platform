...
import { useContest, useUpdateContest } from '@/features/contests/hooks/useContests'
...
export default function EditContestPage() {
  ...
  const { mutate: updateContest, isPending, error } = useUpdateContest()
  ...
  useEffect(() => {
    if (contest) {
      setForm({
        ...
        start_time:  contest.start_time ? new Date(contest.start_time) : null,
        end_time:    contest.end_time   ? new Date(contest.end_time)   : null,
      })
    }
  }, [contest])
    ...
    <div className="max-w-2xl mx-auto space-y-6 animate-fade-in">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-[#8890B0] text-sm mt-0.5">Update contest details</p>
        </div>
      </div>
